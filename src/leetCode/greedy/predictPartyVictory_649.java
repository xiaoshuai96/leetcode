...
public class predictPartyVictory_649 {
    public static void main(String[] args) {
        String rddrd = new predictPartyVictory_649().predictPartyVictory("RDDRD");
        System.out.println(rddrd);
    }

    /**
     * 执行用时：12 ms, 在所有 Java 提交中击败了47.29% 的用户
     * 内存消耗：39.4 MB, 在所有 Java 提交中击败了25.79% 的用户
     * @param senate
     * @return
     */
    public String predictPartyVictory(String senate) {
        int n = senate.length();
        //使用两个队列分别记录radiant和dire出现的先后顺序
