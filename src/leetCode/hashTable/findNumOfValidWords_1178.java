...
public class findNumOfValidWords_1178 {
    public static void main(String[] args) {
        ...
        List<Integer> list = new findNumOfValidWords_1178().findNumOfValidWords(words, puzzles);
        for (Integer i : list) {
            System.out.print(i + "\n");
        }
    }
    public List<Integer> findNumOfValidWords(String[] words, String[] puzzles) {
        ...
        for(String puzzle : puzzles){
            ...
            for (String word : words) {
                boolean flag = true;
                //检查首个字符是否满足条件，如果满足，继续，否则直接结束本次循环
    ...
    public List<Integer> findNumOfValidWords02(String[] words, String[] puzzles) {
